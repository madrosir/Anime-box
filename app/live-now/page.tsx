"use client"
import LiveNowLoad from "@/components/load/livenowLoad";
    ...
    return (
        <div>
            <div className="flex h-16 w-full items-center justify-between bg-slate-900 px-2" >
                ...
                <Link href={"/"} className="flex">
                    ...
                    <Link href={"/top-anime"} className="ml-4">
                        <p className="text-lg font-semibold">Top Anime</p>
                    </Link>
            ...
            <main className="flex flex-col sm:p-16">
                <h2 className="mb-4 bg-gradient-to-l from-blue-600 via-red-500 to-pink-900 bg-clip-text text-center text-3xl font-extrabold text-transparent">
                    Live Now Anime
                </h2>
                <section>
                    <LiveNowLoad />
