"use client"
import UpcomingAnimeLoad from "@/components/load/upcominganime";
        ...
        <div>
            <div className="flex h-16 w-full items-center justify-between bg-slate-900 px-2">
                ...
                <Link href={"/"} className="flex">
                    ...
                    <Link href={"/top-anime"} className="ml-4">
                        <p className="bg-transparent bg-gradient-to-r text-lg font-semibold">Top-anime</p>
                    </Link>
                </div>
            ...
            <main className="flex flex-col sm:p-16">
                <h2 className="mb-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-center text-3xl font-extrabold text-transparent">
                   Upcoming Anime
                </h2>
                <section>
                    <UpcomingAnimeLoad />
